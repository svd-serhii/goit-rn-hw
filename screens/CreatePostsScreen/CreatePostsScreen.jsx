  ...
  return (
    <View style={styles.postContainer}>
      <View style={styles.imgContainer}>
        <TouchableOpacity style={styles.addPostImg} activeOpacity={0.5}>
          <FontAwesome name="camera" size={24} color="black" />
        </TouchableOpacity>
      </View>
      <Text style={styles.addPostText}>Add photo</Text>
      <View style={styles.postFormContainer}>
        <TextInput style={styles.postInput} placeholder="Title..." inputMode="text" />
        <TextInput style={styles.postInput} placeholder="Location" inputMode="navigation" />
